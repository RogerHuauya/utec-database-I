--create schema  lab12;
CREATE TABLE lab12.CANDIDATO (
	partido varchar (120),
	nombre varchar(120),
	totalvotos int
);

CREATE TABLE lab12.departamento (
  id varchar(2) NOT NULL,
  name varchar(45) NOT NULL
);
CREATE TABLE  lab12.provincia (
  id varchar(4) NOT NULL,
  name varchar(45) NOT NULL,
  departamentoid varchar(2) NOT NULL
);
CREATE TABLE lab12.distrito (
...
CREATE TABLE lab12.CentroVotacion (
...
CREATE TABLE lab12.SedeDepartamental(
 Codigo varchar(2) NOT NULL,
 reportado int
);

CREATE TABLE lab12.SedeProvincial(
 Codigo varchar(4) NOT NULL,
 reportado int
);

CREATE TABLE lab12.VotosPorCentro(
...
/* - - - INSERTAR CANDIDATOS - - - */
INSERT INTO CANDIDATO VALUES ('Acción Popular','Yonhy Lescano',0);
INSERT INTO CANDIDATO VALUES ('Alianza para el Progreso','César Acuña',0);
INSERT INTO CANDIDATO VALUES ('Avanza País','Hernando De Soto',0);
INSERT INTO CANDIDATO VALUES ('Contigo','Máximo San Román',0);
INSERT INTO CANDIDATO VALUES ('Democracia Directa','Andrés Avelino Alcantara',0);
INSERT INTO CANDIDATO VALUES ('Frente Amplio','Marco Arana',0);
INSERT INTO CANDIDATO VALUES ('Frente de la Esperanza 2021','Fernando Olivera',0);
INSERT INTO CANDIDATO VALUES ('Fuerza Popular','Keiko Fujimori',0);
INSERT INTO CANDIDATO VALUES ('Juntos por el Perú','Verónika Mendoza',0);
INSERT INTO CANDIDATO VALUES ('Partido Aprista Peruano','Nidia Vílchez',0);
INSERT INTO CANDIDATO VALUES ('Partido Morado','Julio Guzmán',0);
INSERT INTO CANDIDATO VALUES ('Partido Nacionalista Peruano','Ollanta Humala',0);
INSERT INTO CANDIDATO VALUES ('Partido Popular Cristiano','Alberto Beingolea',0);
INSERT INTO CANDIDATO VALUES ('Perú Libre','Pedro Castillo',0);
INSERT INTO CANDIDATO VALUES ('Perú Nación','Francisco Diez Canseco',0);
INSERT INTO CANDIDATO VALUES ('Perú Patria Segura','Rafael Santos',0);
INSERT INTO CANDIDATO VALUES ('Podemos Perú','Daniel Urresti',0);
INSERT INTO CANDIDATO VALUES ('Renovación Popular','Rafael López Aliaga',0);
INSERT INTO CANDIDATO VALUES ('RUNA','Ciro Gálvez',0);
INSERT INTO CANDIDATO VALUES ('Restauración Nacional','George Forsyth',0);
INSERT INTO CANDIDATO VALUES ('Somos Perú','Daniel Salaverry',0);
INSERT INTO CANDIDATO VALUES ('Todos por el Perú','Fernando Cillóniz',0);
INSERT INTO CANDIDATO VALUES ('Unión por el Perú','José Vega',0);
...
--Inicialice sus tablas--
 ...
 INSERT INTO VotosPorCentro(SELECT c.nombre,d.id,null,0
						   FROM distrito d, CANDIDATO c);
INSERT INTO SedeDepartamental(SELECT d.id, 0
							  FROM departamento d);
INSERT INTO SedeProvincial(SELECT p.id,0
						   FROM provincia p);
INSERT INTO CentroVotacion (SELECT d.ID, 0, null, (SELECT count(c.partido)
												   FROM CANDIDATO c), 0, 0
							FROM Distrito d);
INSERT INTO votos1 (SELECT c.nombre,d.id,(select now()), (floor(random()*(10-0+1))+0)
					FROM distrito D, CANDIDATO C);
